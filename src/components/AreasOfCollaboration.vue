<template>
  <div class="areas-of-collaboration">
    <h3><em>Some areas we can explore together:</em></h3>
    <ul>
      <li>
...
.areas-of-collaboration li:hover {
  transform: translateY(-5px);
  box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);
}

.areas-of-collaboration li .icon-placeholder {
  font-size: 24px;
  margin-right: 15px;
  color: #141726;
}

.areas-of-collaboration strong {
  margin-right: 6px;
  color: #141726;
}
</style>
