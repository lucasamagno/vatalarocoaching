<template>
  <div class="diverse-teams">
    <h3 className="content-title">Leading Diverse Teams and Building Inclusive Environments</h3>
...
.diverse-teams {
  ...
  text-align: justify; /* Text aligned to the left */
  margin: 40px; /* Margin around the component */
  background-color: #fff; /* Optional: Sets a white background */
}
