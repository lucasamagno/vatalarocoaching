<template>
  <section class="custom-hero-section">
    <h1 class="page-title">Vatalaro Executive and Leadership Coaching</h1>
    <h3>Are you ready to step into your full potential?</h3>
...
.custom-hero-section {
  ...
  height: 40vh; /* Adjusted height to be slightly smaller */
...
.custom-hero-section h3 {
  ...
  font-size: 2rem; /* Adjusted font size for the subtitle */
  color: inherit; /* Inherits the section's text color */
}
