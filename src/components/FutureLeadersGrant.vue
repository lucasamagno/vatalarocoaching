<template>
    <div class="grants-page">
      ...
      <div class="cta-container">
        <a href="https://www.google.com" class="cta-button">How to Support</a>
      </div>
      ...
      <div class="cta-container">
        <a href="https://www.google.com" class="cta-button">Donate</a>
      </div>
    </div>
  </template>
  ...
  .about-image {
    flex: 1;
    background-image: url('/public/assets/images/TheFutureLeadersGrant/our-mission.jpg'); /* Update this path to your image */
    background-repeat: no-repeat;
  ...
  .support-image {
    flex: 1;
    background-image: url('/public/assets/images/TheFutureLeadersGrant/HowYouCanHelp.jpg'); /* Update this path to your image */
    background-repeat: no-repeat;
    background-position: center;
    background-size: cover;
  }
